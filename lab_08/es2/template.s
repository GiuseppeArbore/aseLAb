...
CRP_Key         DCD     0xFFFFFFFF
				...
				AREA myDataW, DATA, READWRITE
dest			SPACE 64
	
				AREA myDataR, DATA, READONLY
source			DCD 0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF
...
UsageFault_Handler\
                ...
                B       .
                ENDP
SVC_Handler     PROC							;uso msp 
                EXPORT  SVC_Handler               [WEAK]
				
				STMFD SP!, {R0-R12, LR}			;su msp				
				MRS	R1, psp	
...
uscita			LDMFD SP!, {R0-R12, LR}			;prendo da msp
				BX LR
